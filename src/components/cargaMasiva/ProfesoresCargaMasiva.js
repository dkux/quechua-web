...
class ProfesoresCargaMasiva extends React.Component {
                    ...
                    <div className="content-inside" id="content">
                        <Container>
                            ...
                            <Row>
                                <Col sm="12">
                                    <Card>
                                        <CardHeader>Cargar Profesores</CardHeader>
                                        <CardBody>
                                            <form encType="multipart/form-data" onSubmit={this.handleFormSubmit}>
                                                <Row form>
                                                    <Col md={6}>
                                                        <FormGroup>
                                                            <Label>Seleccione un archivo CSV que contenga los profesores a cargar</Label>
                                                            <Input
                                                                type="file"
                                                                id="upload_file"
                                                                name="selectedFile"
    ...
    handleFormSubmit(event){
        ...
        return fetch(`http://localhost:8080/api/administradores/cargarProfesores`,
            {
                headers: headers,
                method: 'POST',
                body: formData
...
export default withAuth(ProfesoresCargaMasiva);
